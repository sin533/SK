...
#    data = pickle.load(f)
#adv_samples = datasets.Dataset.from_dict(data)#对抗样本
train_dataset = datasets.load_dataset('csv', data_files='small-117M-k40.test.csv', split='train[:80]').map(function=dataset_mapping)
eval_dataset = datasets.load_dataset('csv', data_files='small-117M-k40.test.csv', split='train[80:100]').map(function=dataset_mapping)
