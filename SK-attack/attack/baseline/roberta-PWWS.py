...
def main():
    ...
    print('New Attacker:')
    attacker = OpenAttack.attackers.PWWSAttacker()  # 攻击模型
    dataset = datasets.load_dataset('csv',data_files = 'small-117M-k40.test.csv',split='train[30:60]').map(function=data_mapping)
