...
def main():
    ...
    print('New Attacker:BAEAttacker')
    attacker = OpenAttack.attackers.BAEAttacker()  # 攻击模型
    dataset = datasets.load_dataset('csv',data_files = 'small-117M-k40.test.csv',split='train[20:50]').map(function=data_mapping)
    print("Start attack")
